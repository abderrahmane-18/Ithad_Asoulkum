<script>
    ...
    function showValidationError(form, index, value){
        form.find("input[name='"+index+"'][type=file]").parents('.error-here').append('<div class="invalid-feedback d-block">' + value + '</div');
        form.find("input[name='"+index+"'][type!=file]").parent().append('<div class="invalid-feedback d-block">' + value + '</div');
